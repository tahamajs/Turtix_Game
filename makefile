...
all: tutrix.out
tutrix.out: ${BUILD_DIR}/main.o ${BUILD_DIR}/star.o ${BUILD_DIR}/map.o ${BUILD_DIR}/animation.o ${BUILD_DIR}/GamePause.o  ${BUILD_DIR}/Player.o ${BUILD_DIR}/Game.o ${BUILD_DIR}/Score.o ${BUILD_DIR}/menu.o ${BUILD_DIR}/AudioClip.o ${BUILD_DIR}/MusicPlayer.o 
	${CC} ${BUILD_DIR}/main.o ${BUILD_DIR}/star.o ${BUILD_DIR}/map.o ${BUILD_DIR}/animation.o ${BUILD_DIR}/GamePause.o  ${BUILD_DIR}/Player.o ${BUILD_DIR}/Game.o ${BUILD_DIR}/Score.o ${BUILD_DIR}/menu.o ${BUILD_DIR}/AudioClip.o ${BUILD_DIR}/MusicPlayer.o -o ${BUILD_DIR}/tutrix.out ${SFFLAGS} ; ${BUILD_DIR}/tutrix.out
...
${BUILD_DIR}/Game.o: Game.cpp Game.hpp Player.hpp Score.hpp map.hpp GamePause.hpp star.hpp menu.hpp AudioClip.hpp MusicPlayer.hpp
